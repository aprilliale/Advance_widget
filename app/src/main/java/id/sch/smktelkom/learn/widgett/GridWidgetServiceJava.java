...
import id.sch.smktelkom.learn.widgett.ui.PlantDetailActivity;
...
public class GridWidgetServiceJava extends RemoteViewsService {
    @Override
...
class GridRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public void onDataSetChanged() {
        ...
        mCursor = mContext.getContentResolver().query(
                ...
                null,
                null,
                PlantContact.PlantEntry.COLUMN_CREATION_TIME
        );
    }
    ...
    public RemoteViews getViewAt(int position) {
        ...
        int idIndex = mCursor.getColumnIndex(PlantContact.PlantEntry._ID);
        int createTimeIndex = mCursor.getColumnIndex(PlantContact.PlantEntry.COLUMN_CREATION_TIME);
        int waterTimeIndex = mCursor.getColumnIndex(PlantContact.PlantEntry.COLUMN_LAST_WATERED_TIME);
        int plantTypeIndex = mCursor.getColumnIndex(PlantContact.PlantEntry.COLUMN_PLANT_TYPE);
