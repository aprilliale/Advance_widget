package id.sch.smktelkom.learn.widgett.utils;
...
public class PlantUtils {
    ...
    static final long TINY_AGE = DAY_MILLISECONDS * 0;
    static final long JUVENILE_AGE = DAY_MILLISECONDS * 1;
    static final long FULLY_GROWN_AGE = DAY_MILLISECONDS * 2;
